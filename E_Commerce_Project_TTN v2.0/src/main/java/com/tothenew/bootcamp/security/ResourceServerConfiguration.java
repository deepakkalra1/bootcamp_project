...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/user/admin/activate-customer/{email}").hasAnyRole("ADMIN")
                .antMatchers("/user/admin/activate-seller/{email}").hasAnyRole("ADMIN")
                .antMatchers("/user/admin/deactivate-customer/{email}").hasAnyRole("ADMIN")
                .antMatchers("/user/admin/deactivate-seller/{email}").hasAnyRole("ADMIN")
                ...
                .antMatchers("/user/admin/update/category/{id}/{name}").hasAnyRole("ADMIN")
