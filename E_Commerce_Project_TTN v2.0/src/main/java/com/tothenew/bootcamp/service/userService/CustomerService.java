...
public class CustomerService {
    ...
    public CommonResponseVO getCustomerAddresses(String username) {
        List<Address> addressList = customer_repository.findByEmail(username).getAddressList();
        CommonResponseVO<List> commonResponseVO = new CommonResponseVO<>();
     ...
     */
    public void updateCustomerPasswordOnLogedIn(String token,String oldPassword,String newPassword,String confirmPassword){
