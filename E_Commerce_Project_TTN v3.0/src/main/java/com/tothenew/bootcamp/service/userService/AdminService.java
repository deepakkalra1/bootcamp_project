...
public class AdminService {
    ...
    //---------------------------------------------------------------------------------------------------------------->
    @Transactional
    public void activateCustomer(HashMap<String, String> emailHashmap) {
        if (emailHashmap.size()!=1){
            throw new GiveMessageException(Arrays.asList(StatusCode.NOT_VALID_FORMAT.toString()),
                    Arrays.asList("Either you did not provided email or have multiple keys in data. ONLY email is to be provided"));
        }
        String email = emailHashmap.get("email");
        if (email==null){
            throw new GiveMessageException(Arrays.asList(StatusCode.NOT_VALID_FORMAT.toString()),
                    Arrays.asList("'email' key was not used in request json"));
        }
        try {
    ...
    //---------------------------------------------------------------------------------------------------------------->
    @Transactional
    public void de_activateCustomer(HashMap<String, String> emailHashmap) {
        if (emailHashmap.size()!=1){
            throw new GiveMessageException(Arrays.asList(StatusCode.NOT_VALID_FORMAT.toString()),
                    Arrays.asList("Either you did not provided email or have multiple keys in data. ONLY email is to be provided"));
        }
    ...
    //---------------------------------------------------------------------------------------------------------------->
    @Transactional
    public void activateSeller(HashMap<String, String> emailHashmap) {
        if (emailHashmap.size()!=1){
            throw new GiveMessageException(Arrays.asList(StatusCode.NOT_VALID_FORMAT.toString()),
                    Arrays.asList("Either you did not provided email or have multiple keys in data. ONLY email is to be provided"));
        }
    ...
    //---------------------------------------------------------------------------------------------------------------->
    @Transactional
    public void de_activateSeller(HashMap<String, String> emailHashmap) {
        if (emailHashmap.size()!=1){
            throw new GiveMessageException(Arrays.asList(StatusCode.NOT_VALID_FORMAT.toString()),
                    Arrays.asList("Either you did not provided email or have multiple keys in data. ONLY email is to be provided"));
        }
