...
public class Category {
    ...
    //------------------------------------------------------------------------------------------------------------>
    @PutMapping("/user/admin/update/category")
    public ResponseEntity updateSingleCategoryByAdmin(@RequestBody HashMap<String, String> categoryUpdateData)
    {
//        @PathVariable(name = "id")int categoryId ,
//        @PathVariable(name = "name")String categoryNewName
         CommonResponseVO commonResponseVO= categoryService.updateCategoryByAdmin(categoryUpdateData);
        return new ResponseEntity(commonResponseVO, HttpStatus.OK);
    }
